    ...
    <div className="flex flex-col h-full min-h-screen bg-orange-600 dark:bg-zinc-950 text-black dark:text-white transition-colors duration-500">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <div className="space-y-2">
          <h2 className="text-xs font-black text-white/50 uppercase tracking-widest px-2">{t('language')}</h2>
          <button
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                  {languages.find(l => l.code === 'ar')?.label} / English / Français / 中文
                </p>
              </div>
            </div>
        ...
        {/* Dark Mode */}
        <div className="space-y-2">
          <h2 className="text-xs font-black text-white/50 uppercase tracking-widest px-2">{t('dark_mode')}</h2>
          <div className="w-full bg-white dark:bg-zinc-900 p-5 rounded-3xl flex items-center justify-between shadow-lg border border-black/5 dark:border-white/5">
            ...
            <button className="px-4 py-2 bg-orange-600 text-white rounded-xl text-sm font-black">
              تفعيل
            </button>
          </div>
        </div>
        ...
        {/* About App */}
        <div className="space-y-2">
          <h2 className="text-xs font-black text-white/50 uppercase tracking-widest px-2">{t('about')}</h2>
